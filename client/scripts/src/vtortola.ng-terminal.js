...
.provider('terminalConfiguration', function () {
    ...
    var config = function () {
        //LK - me object stores configuration properties
        var me = {};
        //LK - sounds - delete?
        me.typeSoundUrl =null;
        me.startSoundUrl = null;
        //this controls the terminal input prefix.  change user to reflect username or character
        me.promptConfiguration = { end: '$ ', user: 'mean-mud:', separator: 'user ', path: 'benbizzey' };
    ...
    //LK - provider is defined as a function inside of the .provider function -- unresolved
    var provider = function () {
        //LK - local variable me stores the config object defines directly above
        var me = config();
        var configurations = {};
        //LK - redefines the configurations property 'default' (a string, probably for bson) to be 'me' which was just defined as the config function above
        configurations['default'] = me;
        //LK - the above saves the default property of configurations to equal the current value of me
        //LK - below, me.config is redefined after having saved the default settings locally
        ...
        me.$get = ['$q', function ($q) {
          console.log('trying to access terminal sounds');
            //LK - the sounds were throwing errors and are unnecessary
...
.controller('terminalController', ['$scope', 'terminalConfiguration', 'promptCreator', function ($scope, terminalConfiguration, promptCreator) {
    ...
    //prevents unallowed characters from being passed to the
